...
- V1.1: Improved waiting loop for statefile generation to use exponential backoff in the time.sleep calls. Updated documentation.
"""
...
class MTSET_call:
    ...
    def WaitForMainMenu(self) -> list[str]:
        ...
        - interface_output : list[str]
            A list containing the output collected while waiting for MTSET to return to the main menu.
        """
    ...
    def caller(self,
        ...
        """
        Execute the MTSET software to generate the computational grid for the case being considered.

        Requires that the input file, walls.analysis_name, has been made and is available.
        """
        ...
        # If the file was not written yet, use an exponential backoff to avoid unneccesary high workload on thread.
        ...
        elapsed = 0  # Intialize elapsed time to zero
