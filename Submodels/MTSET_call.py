...
- V1.0: Implemented waiting loop until statefile has been generated. Class now automatically deletes statefile if it already existed at start of execution. 
"""
...
class MTSET_call:
    ...
    def __init__(self, 
        ...
        self.streamwise_points = streamwise_points if streamwise_points is not None else 200
